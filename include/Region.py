    ...
    def setVariables(self):
        for v in self.rvars:
            ...
            if v == 'metPuppi_rawPt':
                ...
                self.metPuppi_rawUp   = collection(self.bins[self.rvars.index(v)], v)
                self.metPuppi_rawUp_dy   = collection(self.bins[self.rvars.index(v)], v)
                self.metPuppi_rawUp_da = collection(self.bins[self.rvars.index(v)], v)    
                self.metPuppi_rawUp_tt = collection(self.bins[self.rvars.index(v)], v)    
                self.metPuppi_rawUp_ewk = collection(self.bins[self.rvars.index(v)], v)    
                self.metPuppi_rawDown   = collection(self.bins[self.rvars.index(v)], v)          
                self.metPuppi_rawDown_dy   = collection(self.bins[self.rvars.index(v)], v)
                self.metPuppi_rawDown_da = collection(self.bins[self.rvars.index(v)], v)    
                self.metPuppi_rawDown_tt = collection(self.bins[self.rvars.index(v)], v)    
                self.metPuppi_rawDown_ewk = collection(self.bins[self.rvars.index(v)], v)    
                self.metPuppi_rawunclUp   = collection(self.bins[self.rvars.index(v)], v)
                self.metPuppi_rawunclUp_dy   = collection(self.bins[self.rvars.index(v)], v)
                self.metPuppi_rawunclUp_da = collection(self.bins[self.rvars.index(v)], v)    
                self.metPuppi_rawunclUp_tt = collection(self.bins[self.rvars.index(v)], v)    
                self.metPuppi_rawunclUp_ewk = collection(self.bins[self.rvars.index(v)], v)    
                self.metPuppi_rawunclDown   = collection(self.bins[self.rvars.index(v)], v)      
                self.metPuppi_rawunclDown_dy   = collection(self.bins[self.rvars.index(v)], v)
                self.metPuppi_rawunclDown_da = collection(self.bins[self.rvars.index(v)], v)    
                self.metPuppi_rawunclDown_tt = collection(self.bins[self.rvars.index(v)], v)    
                self.metPuppi_rawunclDown_ewk = collection(self.bins[self.rvars.index(v)], v)    
                self.metPuppi_pt_qcd   = collection(self.bins[self.rvars.index(v)], v)
                self.metPuppi_pt_gjets   = collection(self.bins[self.rvars.index(v)], v)
                self.metPuppi_pt_wg = collection(self.bins[self.rvars.index(v)], v)  
                self.metPuppi_pt_wj = collection(self.bins[self.rvars.index(v)], v)  
            ...
            if v == 'met_rawPt':
                ...
                self.met_rawUp   = collection(self.bins[self.rvars.index(v)], v)
                self.met_rawUp_dy   = collection(self.bins[self.rvars.index(v)], v)
                self.met_rawUp_da = collection(self.bins[self.rvars.index(v)], v)    
                self.met_rawUp_tt = collection(self.bins[self.rvars.index(v)], v)    
                self.met_rawUp_ewk = collection(self.bins[self.rvars.index(v)], v)    
                self.met_rawDown   = collection(self.bins[self.rvars.index(v)], v)          
                self.met_rawDown_dy   = collection(self.bins[self.rvars.index(v)], v)
                self.met_rawDown_da = collection(self.bins[self.rvars.index(v)], v)    
                self.met_rawDown_tt = collection(self.bins[self.rvars.index(v)], v)    
                self.met_rawDown_ewk = collection(self.bins[self.rvars.index(v)], v)    
                self.met_rawunclUp   = collection(self.bins[self.rvars.index(v)], v)
                self.met_rawunclUp_dy   = collection(self.bins[self.rvars.index(v)], v)
                self.met_rawunclUp_da = collection(self.bins[self.rvars.index(v)], v)    
                self.met_rawunclUp_tt = collection(self.bins[self.rvars.index(v)], v)    
                self.met_rawunclUp_ewk = collection(self.bins[self.rvars.index(v)], v)    
                self.met_rawunclDown   = collection(self.bins[self.rvars.index(v)], v)      
                self.met_rawunclDown_dy   = collection(self.bins[self.rvars.index(v)], v)
                self.met_rawunclDown_da = collection(self.bins[self.rvars.index(v)], v)    
                self.met_rawunclDown_tt = collection(self.bins[self.rvars.index(v)], v)    
                self.met_rawunclDown_ewk = collection(self.bins[self.rvars.index(v)], v)    
                ...
                self.met_rawpt_da = collection(self.bins[self.rvars.index(v)], v)         
                self.met_rawUp   = collection(self.bins[self.rvars.index(v)], v)
                self.met_rawUp_qcd   = collection(self.bins[self.rvars.index(v)], v)
                self.met_rawUp_gjets   = collection(self.bins[self.rvars.index(v)], v)
                self.met_rawUp_wg = collection(self.bins[self.rvars.index(v)], v)  
                self.met_rawUp_wj = collection(self.bins[self.rvars.index(v)], v)  
                self.met_rawUp_ttg = collection(self.bins[self.rvars.index(v)], v)  
                self.met_rawUp_zg = collection(self.bins[self.rvars.index(v)], v)  
                self.met_rawUp_da = collection(self.bins[self.rvars.index(v)], v)         
                self.met_rawDown   = collection(self.bins[self.rvars.index(v)], v)
                self.met_rawDown_qcd   = collection(self.bins[self.rvars.index(v)], v)
                self.met_rawDown_gjets   = collection(self.bins[self.rvars.index(v)], v)
                self.met_rawDown_wg = collection(self.bins[self.rvars.index(v)], v)  
                self.met_rawDown_wj = collection(self.bins[self.rvars.index(v)], v)  
                self.met_rawDown_ttg = collection(self.bins[self.rvars.index(v)], v)  
                self.met_rawDown_zg = collection(self.bins[self.rvars.index(v)], v)  
                self.met_rawDown_da = collection(self.bins[self.rvars.index(v)], v)               
