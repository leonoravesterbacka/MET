...
gSystem->CompileMacro("plotterPuppi.C", channel);
   ...
   // testRatioEEMuMuGJetsComparison("met_uParavs_nVert", "met_uParaPuppivs_nVert", "# Vertices", channel);
   // testRatioEEMuMuGJetsComparison("met_uPerpvs_nVert", "met_uPerpPuppivs_nVert", "# Vertices", channel);
