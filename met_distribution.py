...
if __name__ == "__main__":
    ...
    if doDY:
        ...
        #ewkDatasets =  ['TGJets', 'TTGJets', 'ZGJets', 'ZGJets40to130', 'ZGTo2LG', 'WGToLNuG']
    ...
    met = []
    if doDY:
        #doVariables = ['met_sig_1jet']
        #doVariables = [ 'nVert', 'met_sig', 'met_sig_1jet']
        #doVariables = [ 'nVert', 'met_sig', 'met_sig_1jet', 'met_uPerp', 'met_uPara',  'metPuppi_uPerp', 'metPuppi_uPara']
        doVariables = ['met_sig', 'met_sig_1jet', 'met_pt', 'metPuppi_pt', 'met_uPerp', 'met_uPara',  'metPuppi_uPerp', 'metPuppi_uPara']
        #binnings    = [range(2, 100, 2)]
        #binnings    = [ range(0, 50, 2),range(2, 100, 2), range(2, 100, 2)]
        binnings    = [range(2, 100, 2), range(2, 100, 2), range(0, 200, 5), range(0, 200, 5) ,range(-200, 200, 5),range(-200, 200, 5), range(-200, 200, 5),range(-200, 200, 5)]
        dependence = 'zll_pt'
        ZtoLL = Region.region('Zto',
                           cuts.leps(), doVariables, dependence, 'met', binnings, True)
        regions.append(ZtoLL)                                                                                   
    else:
        #doVariables = [ 'gamma_hOverE', 'gamma_sigmaIetaIeta', 'gamma_r9']
        doVariables = [ 'met_uPara', 'met_uPerp']
        #doVariables = [ 'nVert']
        #doVariables = [ 'gamma_pt', 'nVert','met_pt', 'met_uPara',  'met_uPerp']
        #binnings    = [hoverebins, sigmabins, r9bins]
        binnings    = [ range(-200, 200, 5), range(-200, 200, 5) ]
        #binnings    = [ range(0, 50, 2)]
    ...
    for reg in regions:
        ...
        for var in reg.rvars:  
            ...
            if var == 'met_pt':
                ...
                phi = ['met_rawPhi', 'met_jecUp_rawPhi', 'met_jecDown_rawPhi', 'met_shifted_UnclusteredEnUp_rawPhi', 'met_shifted_UnclusteredEnDown_rawPhi']
                justMET = True;                                                                                                                                      
                ...
                phi = ['metPuppi_rawPhi', 'metPuppi_jecUp_rawPhi', 'metPuppi_jecDown_rawPhi', 'metPuppi_shifted_UnclusteredEnUp_rawPhi', 'metPuppi_shifted_UnclusteredEnDown_rawPhi']
