...
gSystem->CompileMacro("plotter.C", channel);
   ...
   testRatioEEMuMuGJetsComparison("met_uParavs_zll_pt","gamma_met_uPara_vs_gamma_pt",  "q_{T} [GeV]") ;
   testRatioEEMuMuGJetsComparison("met_uPerpvs_zll_pt","gamma_met_uPerp_vs_gamma_pt",  "q_{T} [GeV]");   
